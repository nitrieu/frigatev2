...
void Params::ComputeGateAndAuthNumbers(uint64_t num_pre_gates, uint64_t num_pre_inputs, uint64_t num_pre_outputs) {
  ...
  // std::cout << "num_pre_inputs: " << num_pre_inputs << std::endl;
  // std::cout << "num_inp_bucket: " << num_inp_bucket << std::endl;
  // std::cout << "num_pre_gates: " << num_pre_gates << std::endl;
  // std::cout << "num_bucket: " << num_bucket << std::endl;
  // std::cout << "q_g: " << q_g << std::endl;
  // std::cout << "Q: " << Q << std::endl;
  
  // std::cout << "num_auth: " << num_auth << std::endl;
  ...
  // std::cout << "num_garbled_wires: " << num_garbled_wires << std::endl;
  left_keys_start = 0;
  right_keys_start = Q;
  out_keys_start = 2 * Q;
  auth_start = 3 * Q;
